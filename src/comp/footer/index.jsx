      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
              ...
              {socials.map(({ href, label, Icon }) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.borderColor = "rgba(0,200,255,0.38)";
                  }}
                  onMouseLeave={(e) => {
          ...
          >
            ...
            {[
              ...
              <Link
                ...
                to={to}
                className="nav-link"
                style={{ fontSize: "0.88rem", width: "fit-content" }}
              >
                {label}
              </Link>
            ))}
        ...
        >
          <p style={{ color: "var(--muted)", fontSize: "0.76rem" }}>
            © {new Date().getFullYear()} Manuel Westermeier
          </p>
          <p style={{ color: "var(--muted)", fontSize: "0.76rem" }}>
            {window.cw
              ? "Erstellt mit ChiemWeb"
